...
var (
	employeeDBTypes = map[string]string{`ID`: `uuid`, `CompanyID`: `uuid`, `Firstname`: `character varying`, `Lastname`: `character varying`, `Email`: `character varying`, `Birthdate`: `timestamp without time zone`}
	_               = bytes.MinRead
)
