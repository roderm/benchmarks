...
type Product struct {
	...
	ProdType     null.String  `boil:"prod_type" json:"prod_type,omitempty" toml:"prod_type" yaml:"prod_type,omitempty"`
	Manufactured null.Int     `boil:"manufactured" json:"manufactured,omitempty" toml:"manufactured" yaml:"manufactured,omitempty"`
	Sold         null.Int     `boil:"sold" json:"sold,omitempty" toml:"sold" yaml:"sold,omitempty"`
...
var ProductWhere = struct {
	...
	ProdType     whereHelpernull_String
	Manufactured whereHelpernull_Int
	Sold         whereHelpernull_Int
	Price        whereHelpernull_Float64
	Released     whereHelpernull_Time
}{
	ID:           whereHelperstring{field: "\"product\".\"id\""},
	CompanyID:    whereHelperstring{field: "\"product\".\"company_id\""},
	Name:         whereHelpernull_String{field: "\"product\".\"name\""},
	ProdType:     whereHelpernull_String{field: "\"product\".\"prod_type\""},
	Manufactured: whereHelpernull_Int{field: "\"product\".\"manufactured\""},
	Sold:         whereHelpernull_Int{field: "\"product\".\"sold\""},
	Price:        whereHelpernull_Float64{field: "\"product\".\"price\""},
	Released:     whereHelpernull_Time{field: "\"product\".\"released\""},
}
...
var (
	productAllColumns            = []string{"id", "company_id", "name", "prod_type", "manufactured", "sold", "price", "released"}
	productColumnsWithoutDefault = []string{"company_id", "name", "prod_type", "manufactured", "sold", "price", "released"}
